...
namespace ReconciliationDemo.Core.Utility
{
    public class SqlManager : IDisposable
    {
        ...
        public int ExecuteNonQueryWithID(string procedureName, List<SqlParameter> paramList = null)
        {
            int records = 0;
            using (SqlCommand sqlCommand = new SqlCommand())
            {
                try
                {
                    ...
                    foreach (SqlParameter item in paramList)
                    {
                     ...
                     records = Convert.ToInt32(sqlCommand.Parameters["@ID"].Value);
                }
                catch (Exception exception)
                {
                    throw exception;
        ...
        /// <summary>
        /// Ganesh Rajak
        /// For reading single value data from tables
        /// </summary>
        /// <param name="ExecuteReader"></param>
        /// <param name="Command String"></param>
        /// <returns></returns>
        public String ExecuteReader(string CommandString, String colname)
        {
            //DataTable dtResult = null;
            //SqlDataAdapter dbAdapter = null;
        ...
        /// <summary>
        /// Created By: Ganesh Rajak
        /// For Running the customize query directly and retrieving the results as DataTable
        /// </summary>
        /// <param name="command"></param>
        /// <returns></returns>
        public DataTable ExecutePlainTextQuery(String command,String TableName)
        {
            DataTable dtResult = null;
            SqlDataAdapter dbAdapter = null;
        ...
        public DataTable Fill_lowperformingDataTable(string procedureName, List<SqlParameter> paramList = null)
        {
            DataTable dtResult = null;
            SqlDataAdapter dbAdapter = null;
